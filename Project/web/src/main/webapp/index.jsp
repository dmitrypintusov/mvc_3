							...
							<div class="row">
								<div class="col-lg-12">
									...
									<form id="register-form" action="controller" method="post" role="form" style="display: none;">
										...
										<div class="form-group">
											<input type="text" name="login" tabindex="3" class="form-control" placeholder="login" required>
										</div>
										<div class="form-group">
											<input type="password" name="password" tabindex="4" class="form-control" placeholder="Password" required>
										</div>
										<div class="form-group">
											<input type="radio" name="accessLevel" value="STUDENT" class="form-control" checked />STUDENT
											<input type="radio" name="accessLevel" value="TEACHER" class="form-control" />TEACHER
										</div>
										<div class="form-group">
											<div class="row">
												<div class="col-sm-6 col-sm-offset-3">
